...
const AppModal = {
  ...
  mounted() {
    ...
    this.$watch(
      (vm) => [vm.isOpen, vm.blockScrollOnMount],
      () => {
      ...
      setTimeout(() => {
        if (this.finalFocusRef) {
          ...
          if (finalFocusRef) {
            ...
            console.warn(
              `[ChakraUI Modal]: Unable to locate final focus node "${this.finalFocusRef}".`
            )
          }
        }
      })
        ...
        h(
          FocusTrap,
          {
            props: {
              returnFocusOnDeactivate:
                this.returnFocusOnClose && !this.finalFocusRef,
              active: this.isOpen,
            },
            on: {
          ...
          [
            h(
              'div',
              {
                style: { position: 'relative', zIndex: this.portalZIndex },
                directives: [
                  {
                    name: 'scroll-lock',
