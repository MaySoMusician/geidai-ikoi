  ...
  <div>
    ...
    <CBox as="section" :class="[$style.SectionContainer]">
      ...
      <CFlex justify="center" align="center" :mt="8">
        <DR1AppButton as="nuxt-link" text="詳しく" to="/dr1/intro/" />
      </CFlex>
    </CBox>
...
const vue = Vue.extend<Data, Methods, Computed, unknown>({
  ...
  data() {
    return {
      ...
      unwatchUser: null,
      linksToAbout: [
        { text: 'コメント', to: '/dr1/about/#comments' },
        { text: 'お問い合わせ', to: '/dr1/about/#contacts' },
        { text: '募集案内', to: '/dr1/about/#' },
        { text: '権利表示', to: '/dr1/about/#attributions' },
      ],
      photos: [
